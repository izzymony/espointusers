...
const menuItems = [
  ...
  { href: '/browse', label: 'Browse', icon: <Search className="w-5 h-5" /> },
...
const Nav = () => {
  ...
  return (
    <div>
      <header className="border-b border-border bg-[#fffdf6]/90 backdrop-blur-sm fixed w-full top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden p-2 rounded text-gray-700 hover:text-orange-500"
        ...
        {/* Mobile Menu Drawer */}
        {menuOpen && (
          <div className="md:hidden absolute top-[72px] left-0 w-full bg-[#fffdf6] shadow-lg z-50">
